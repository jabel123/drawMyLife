...
왜 사라지는거야 개새끼야
<link rel="stylesheet" href="/web/resources/daumeditor/css/editor.css" type="text/css" charset="utf-8"/>
...
<div id="tx_trex_container" class="tx-editor-container">
					...
					<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
						...
						<div class="tx-menu-footer">
							<img class="tx-menu-confirm"
								src="${contextPath }/resources/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1"
								alt="" /> <img class="tx-menu-cancel" hspace="3"
								src="${contextPath }/resources/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1"
								alt="" />
						</div>
					</div>
				</li>
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading">
			<div>
				<img src="${contextPath }/resources/daumeditor/images/icon/editor/loading2.png" width="113"
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder"
			src="${contextPath }/resources/daumeditor/images/icon/editor/skin/01/btn_drag01.gif"
